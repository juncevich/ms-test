...
public class MessageServiceImplTest {
    ...
    @Test
    public void testSendGetResultRequest() {
        given(rabbitTemplate.convertSendAndReceive(
                any(String.class), any(String.class), any(String.class), any(CorrelationData.class))
        ).willReturn(RESULTS);

        String results = messageService.sendGetResultRequest();
